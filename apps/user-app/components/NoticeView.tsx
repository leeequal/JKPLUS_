    ...
    if (sortedNotices.length === 0) {
        return (
            <div className="text-center py-16 px-6 bg-slate-800/50 border-2 border-dashed border-slate-700 rounded-xl">
                ...
                <h3 className="mt-4 text-lg font-medium text-slate-300">등록된 공지사항 없음</h3>
            ...
            {sortedNotices.map((notice) => {
                ...
                return (
                    <div key={notice.id} className="bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden">
                        ...
                        >
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    {notice.isPinned && <span className="bg-amber-600/80 text-white text-[10px] px-1.5 py-0.5 rounded font-bold">중요</span>}
                        ...
                        >
                            <div className={`p-4 border-t border-slate-700 ${!isExpanded && 'hidden'}`}>
